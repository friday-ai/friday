...
const UnderConstruction: React.FunctionComponent = () => {
  ...
  return (
    <div className="geo-background centered-container">
      ...
      <h1 className={`mt-5 text-4xl font-bold text-center ${theme.errorPages.primaryText}`}>Coming soon</h1>
      <span className={`mt-5 text-lg text-gray-400 text-center ${theme.errorPages.secondaryText}`}>
        All contributors of project are currently working hard to build this page.
      </span>
    </div>
  );
};
