...
const UndrawServerDown: React.FC<SVGProps> = ({ className = '', height = '699', width = '1119.60911' }) => {
  ...
  return (
    <svg
      id="de53bd0b-4962-42bd-a83f-da8828b7241a"
    ...
    >
      ...
      <path d="M140.09162,291.85056c0-78.36865,54.255-141.78356,121.30372-141.78356" transform="translate(-31.39089 -100.5)" fill={colors.primary} />
      <path d="M70.77521,158.66768c0,73.61476,31.00285,133.18288,69.31641,133.18288" transform="translate(-31.39089 -100.5)" fill={colors.primary} />
      ...
      <rect x="271.60911" y="150" width="16" height="16" fill={colors.primary} opacity="0.4" />
      <rect x="294.60911" y="150" width="16" height="16" fill={colors.primary} opacity="0.8" />
      <rect x="317.60911" y="150" width="16" height="16" fill={colors.primary} />
      <rect x="271.60911" y="251" width="16" height="16" fill={colors.primary} opacity="0.4" />
      <rect x="294.60911" y="251" width="16" height="16" fill={colors.primary} opacity="0.8" />
      <rect x="317.60911" y="251" width="16" height="16" fill={colors.primary} />
      <rect x="271.60911" y="352" width="16" height="16" fill={colors.primary} opacity="0.4" />
      <rect x="294.60911" y="352" width="16" height="16" fill={colors.primary} opacity="0.8" />
      <rect x="317.60911" y="352" width="16" height="16" fill={colors.primary} />
