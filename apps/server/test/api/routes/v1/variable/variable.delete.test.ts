...
describe('DELETE /api/v1/variable/:id', () => {
  ...
  it('admin should\'t have to delete a variable', async () => {
    await server
      .delete('/api/v1/variable/a2b9ba3a-72f1-4a24-b268-e3813c1e8f32', admin)
      .expect(403);
  });

  it('habitant should\'t have to delete a variable', async () => {
    await server
      .delete('/api/v1/variable/a2b9ba3a-72f1-4a24-b268-e3813c1e8f32', habitant)
      .expect(403);
  });

  it('guest should\'t have to delete a variable', async () => {
    await server
      .delete('/api/v1/variable/a2b9ba3a-72f1-4a24-b268-e3813c1e8f32', guest)
      .expect(403);
  });
